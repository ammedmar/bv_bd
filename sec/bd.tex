...
\section{Homotopy theory of Beilinson--Drinfeld Algebras}

\begin{theorem}
There exists an equivalence of $\infty$-categories between $\BV_\infty$-formal moduli problems and $\BD$-algebras. 
\end{theorem}
...
\subsection{Free BD-algebras in renormalisation theory}
\textcolor{blue}{read more the PhD thesis of Jakob Ulmer}
